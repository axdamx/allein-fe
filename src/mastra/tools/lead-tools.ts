...
export const createLeadTool = createTool({
  id: 'create-lead',
  description:
    'Save a contact as a new lead in the CRM. Use when the user wants to add, save, or record a person/prospect. PROACTIVELY extract name, email, phone, company from the conversation context — do NOT ask the user for details they already provided.',
...
export const createReminderTool = createTool({
  id: 'create-reminder',
  description:
    'Create a follow-up reminder. Use when the user wants to be reminded, follow up, or schedule something for later. Extract the title, description, due date, and person from the conversation context — do not ask the user for details they already mentioned.',
  inputSchema: z.object({
